...
'DIMMING VARIABLES
DIM beta_agency, row, col, intake_docs_recd_dialog, paternity_wkst_check, rec_of_parentage_check, prism_case_number, date_recd, app_supp_coll_services_check, app_fee_check, ref_supp_coll_app_check, good_cause_check, role_county_atty_check, aff_arrears_check, waiver_pers_service_check, birth_check, marriage_check, court_order_check, photo_check, insurance_check, ButtonPressed, other_recd, worker_signature   


'THE DIALOG BOX-------------------------------------------------------------------------------------------------------------------

BeginDialog intake_docs_recd_dialog, 0, 0, 341, 200, "Intake Documents Received"
  EditBox 70, 5, 75, 15, prism_case_number
  ...
  CheckBox 15, 55, 130, 10, "Referral to Supp/Coll DHS-3163B", ref_supp_coll_app_check
...
EMWriteScreen "**Intake Docs Rec'd**", 16, 4          'Types "Intake Docs Rec'd" on first line of CAAD note
